...
#create a for loop
releases <- seq(50,500,50)

outFolder <- "mgdrive/run_MEREA_norelease"
...
# releasesParametersMale <- list(releasesStart=100, # Release starts at generation 0
#                               releasesNumber=1, # Single release event 
#                               releasesInterval=0,  
#                               releaseProportion=releases[[i]]) #Can tweak male and female releases separately #Adjust threshold testing here

# releasesParametersFemale <- list(releasesStart=100,  
#                                 releasesNumber=1,  
#                                 releasesInterval=0,  
